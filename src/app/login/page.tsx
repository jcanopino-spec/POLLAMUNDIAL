    ...
    <main className="min-h-dvh flex items-center justify-center bg-gradient-to-b from-emerald-950 to-slate-950 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-slate-900/80 border border-emerald-800/40 p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Polla Mundial 2026</h1>
          <p className="text-emerald-400/80 text-sm mt-1">Canadá · México · Estados Unidos</p>
        </div>
        <form action={action} className="space-y-4">
          ...
          <div>
            <label htmlFor="pin" className="block text-sm text-slate-300 mb-1">PIN (4 dígitos)</label>
            <input
