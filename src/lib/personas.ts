...
const P: Record<string, Persona> = {
  ...
  'Sandra Patiño': { emoji: '🧵', tag: 'Diseñadora de ropa', prompt: 'Máquina de coser fabricando la camiseta de la selección' },
...
const APODOS: Record<string, string> = {
  ...
  'doña gues': 'Sandra Patiño', matias: 'Matias Salazar', ivancho: 'Ivan Velez',
